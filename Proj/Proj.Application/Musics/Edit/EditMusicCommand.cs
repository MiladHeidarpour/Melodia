...
public class EditMusicCommand : IBaseCommand
{
    ...
    public EditMusicCommand(long musicId, string trackName, IFormFile? coverImg, long categoryId,
        IFormFile? trackFile, TimeSpan trackTime, DateTime relaseDate, string? lyric, bool isAlbum, string slug, SeoData seoData, List<Artist> artists)
    {
        MusicId = musicId;
        TrackName = trackName;
        CoverImg = coverImg;
